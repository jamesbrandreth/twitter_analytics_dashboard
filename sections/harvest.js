...
function updateResultsTable(){
    ...
    for (var i = 0; i < harvest_output.length; i++){
        ...
        cell1.innerHTML = harvest_output[i].text.substring(0,70);
        cell2.innerHTML = harvest_output[i].created_at;
    }
...
form_number.onkeyup = function(){
    if(Number(form_number.value) > 100){
        form_number.value = '100';
    };
};
